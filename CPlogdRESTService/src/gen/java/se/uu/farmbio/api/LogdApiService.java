...
public abstract class LogdApiService {
	public abstract Response logdGet( @NotNull String smiles, Double confidence,SecurityContext securityContext) throws NotFoundException;
	public abstract Response logdImageGet( @NotNull String smiles, Double confidence, int imageWidth, int imageHeight, SecurityContext securityContext) throws NotFoundException;
